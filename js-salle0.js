...
import { STATE, allerA, marquerSiteTermine } from './js-main.js?v=2';
import { demarrerSalle1 } from './js-salle1.js?v=2';
...
function initCouloir() {
  ...
  const portePassage = document.getElementById('couloirPorte');
  portePassage.addEventListener('click', () => {
    portePassage.disabled = true;
