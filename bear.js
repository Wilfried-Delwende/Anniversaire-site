...
<svg class="bear" viewBox="0 0 200 240" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  <g class="bear__arm bear__arm--left">
    <ellipse cx="0" cy="0" rx="15" ry="34"></ellipse>
  </g>
  ...
  <g class="bear__head">
    <circle class="bear__ear bear__ear--left" cx="62" cy="35" r="19"></circle>
    <circle class="bear__ear bear__ear--right" cx="138" cy="35" r="19"></circle>
    <circle class="bear__ear-inner bear__ear-inner--left" cx="62" cy="35" r="9"></circle>
    <circle class="bear__ear-inner bear__ear-inner--right" cx="138" cy="35" r="9"></circle>
...
function createBear(container) {
  ...
  function setPose(poseName) {
    el.className = 'bear bear--pose-' + poseName;
  }
